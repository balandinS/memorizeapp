...
const Input = (props) => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <TouchableOpacity style={{alignItems: 'center',justifyContent: 'center' ,width: 70}}>
         {props.isPassword && props.screenName === SIGNIN && <Text style={styles.forgot}>Forgot?</Text>}
      </TouchableOpacity>
      </View>
      {props.isErrMsg.isValid && <Text style={styles.errorMsg}>*{props.isErrMsg.msg}</Text>}
    </View>
  );
};
